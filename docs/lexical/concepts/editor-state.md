...
<p>
  └─ <b>
      └─ "Because he couldn't handle his "
      └─ <i>
          └─ "Promise"
      └─ "s"
```
...
<p>
  ...
  └─ <b> "Because he couldn't handle his " </b>
  └─ <i> "Promise" </i>
  └─ <b> "s" </b>
```
...
> **tip:** For a deep dive into how state updates work, check out this blog post by Lexical contributor @DaniGuardiola.
